...
foreach ($setting as $key => $value) {
    ...
    if($value->key_term=='enable_billing'){
        $enable_billing = $value->value;
    }

    if($value->key_term=='invoices_address'){
        $invoices_address = $value->value;
    }

    if($value->key_term=='invoice_notes'){
        $invoice_notes = $value->value;
    }
	...
	<div class="tab-content">
		<div class="tab-pane fade show active" id="billing_general_pill">
			...
			<div class="form-group col-md-12">
				...
				<label class="switch">
					<input type="checkbox" name="enable_billing" <?php if($enable_billing=='yes') echo "checked" ?>>
		...
		<div class="tab-pane fade" id="billing_automation_pill">
			...
			<div class="form-group col-md-12">
				...
				<textarea name="invoices_address" class="form-control">{{$invoices_address}}</textarea>
			...
			<div class="form-group col-md-12">
				...
				<textarea name="invoice_notes" class="form-control">{{$invoice_notes}}</textarea>
