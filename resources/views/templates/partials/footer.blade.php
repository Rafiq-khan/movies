<div class="navbar navbar-expand-lg navbar-light">
				...
				<div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2019 - {{date('Y')}}. <a href="#">Movies Dashboard</a> by <a href="www.kreashion.com" target="_blank">Kreashion Software House</a>
					</span>
	...
	<script src="{{asset('public/global_assets/js/demo_charts/pages/dashboard/light/lines.js')}}"></script>	
	<script src="{{asset('public/global_assets/js/demo_charts/pages/dashboard/light/areas.js')}}"></script>
	<script src="{{asset('public/global_assets/js/demo_charts/pages/dashboard/light/donuts.js')}}"></script>
	<script src="{{asset('public/global_assets/js/demo_charts/pages/dashboard/light/bars.js')}}"></script>
	<script src="{{asset('public/global_assets/js/demo_charts/pages/dashboard/light/progress.js')}}"></script>
